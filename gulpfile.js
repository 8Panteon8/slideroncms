let localhost = "localhost:8888/superslider.loc", // Local domain
...
function scripts() {
    return src(`themes/${theme}/assets/javascript/app.js`)
        .pipe(
            webpackStream(
                {
                    mode: "production",
...
function styles() {
    return src([
        `themes/${theme}/assets/style/theme.*`,
        `!themes/${theme}/assets/style/_*.*`,
    ])
...
function startwatch() {
    watch(
        `themes/${theme}/assets/style/**/*`,
        { usePolling: true },
        styles
    );
    watch(
        [
            `themes/${theme}/assets/javascript/**/*.js`,
